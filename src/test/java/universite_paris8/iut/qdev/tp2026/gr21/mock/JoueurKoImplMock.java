...
public class JoueurKoImplMock implements IJoueurService {
    ...
    public Joueur ajouterUnJoueur(String pseudo, String prenom,
        ...
        throw new UsernameTakenException(pseudo); // Toujours en erreur
    }

    @Override
    public ArrayList<Joueur> recupererListeJoueurs() throws EmptyListException {
        throw new EmptyListException(); // Toujours en erreur
    }
